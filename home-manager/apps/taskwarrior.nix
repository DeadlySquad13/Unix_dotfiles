  ...
  programs.taskwarrior = {
    ...
    config = {
      ...
      urgency = {
        ...
        # * Priority.
        uda.priority.H.coefficient=6.0;
        uda.priority.M.coefficient=3.9;
        uda.priority.L.coefficient=-1.8;
